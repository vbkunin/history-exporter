...
$(function()
{
    ...
    // "historyexporter" the widget name
    $.widget( "itop.historyexporter",
    {
        // default options
        options:
        {
            filter: '',
            ajax_page_url: '',
            labels: {dialog_title: 'History Export', export_button: 'Export', cancel_button: 'Cancel', download_button: 'Download', complete: 'Complete', cancelled: 'Cancelled' }
        },
        ...
        {
            this.element
            .removeClass('itop-historyexporter');
        },
        ...
        _start: function()
        {
            ...
            // var bHistoryOnly = $('#export-history-only').prop('checked');
            ...
            this.ajaxCall = $.post(this.options.ajax_page_url, {filter: this.options.filter, operation: 'xlsx_start' /*, historyOnly: bHistoryOnly */}, function(data) {
                this.ajaxCall = null;
...
function HistoryExportDialog(sFilter, sUrl)
{
  $.post(sUrl, {operation: 'history_export_dialog', filter: sFilter}, function(data) {
    $('body').append(data);
  });
}